...
class ForceFieldPatch :
    ...
    def __add__ (self, other) :
        ...
        """
        ret = self.copy()
        if len(ret.comment)==0 : ret.comment = other.comment
        ...
        ret.dihedrallines += [other.dihedrallines[i] for i,t in enumerate(other.dihedraltypes) if not t in self.dihedraltypes]
        ret.improperlines += [other.improperlines[i] for i,t in enumerate(other.impropertypes) if not t in self.impropertypes]
